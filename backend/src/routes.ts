...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/companies/:companyId/customer-contacts", authMiddleware, requireCustomerMiddleware, async (req: Request, res: Response) => {
    try {
      const { companyId } = req.params;
      const userId = (req as any).user.id;
  ...
  app.post("/api/companies/:companyId/customer-contacts", authMiddleware, requireCustomerMiddleware, async (req: Request, res: Response) => {
    try {
      const { companyId } = req.params;
      const userId = (req as any).user.id;
  ...
  app.post("/api/companies/:companyId/customer-contacts/import", authMiddleware, requireCustomerMiddleware, async (req: Request, res: Response) => {
    try {
      const { companyId } = req.params;
      const userId = (req as any).user.id;
  ...
  app.put("/api/companies/:companyId/customer-contacts/:id", authMiddleware, requireCustomerMiddleware, async (req: Request, res: Response) => {
    try {
  ...
  app.delete("/api/companies/:companyId/customer-contacts/:id", authMiddleware, requireCustomerMiddleware, async (req: Request, res: Response) => {
    try {
      const { companyId, id } = req.params;
      const userId = (req as any).user.id;
...
Respond with just the category name, nothing else.`;
  ...
  app.get("/api/companies/:companyId/activity-logs", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { companyId } = req.params;
  ...
  app.get("/api/companies/:companyId/backups", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { companyId } = req.params;
  ...
  // Create a new backup
  app.post("/api/companies/:companyId/backups", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { companyId } = req.params;
  ...
  app.get("/api/backups/:id", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { id } = req.params;
  ...
  app.get("/api/backups/:id/download", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { id } = req.params;
  ...
  app.post("/api/backups/:id/restore-preview", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { id } = req.params;
  ...
  app.post("/api/backups/:id/restore", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { id } = req.params;
  ...
  // Delete backup
  app.delete("/api/backups/:id", authMiddleware, async (req: Request, res: Response) => {
    try {
      const userId = (req as any).user?.id;
      const { id } = req.params;
