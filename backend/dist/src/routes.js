...
import { insertUserSchema, insertCompanySchema, insertAccountSchema, categorizationRequestSchema, insertWaitlistSchema, insertRegulatoryNewsSchema } from "../shared/schema.js";
import { z } from "zod";
import * as googleSheets from "./integrations/googleSheets.js";
...
function requireClientMiddleware(req, res, next) {
    const user = req.user;
    if (!user) {
...
function requireCustomerMiddleware(req, res, next) {
    const user = req.user;
    if (!user) {
        return res.status(401).json({ message: 'Authentication required' });
    }
...
async function seedChartOfAccounts(companyId) {
    ...
    try {
        const createdAccounts = await storage.createBulkAccounts(defaultAccounts);
...
export async function registerRoutes(app) {
    ...
    app.post("/api/companies/:id/seed-accounts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Check if user has access to this company
    ...
    app.get("/api/companies/:companyId/accounts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/companies/:companyId/accounts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Verify company access
    ...
    app.put("/api/accounts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/accounts/:id/archive", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            const account = await storage.getAccount(id);
    ...
    app.post("/api/accounts/:id/unarchive", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            const account = await storage.getAccount(id);
    ...
    app.delete("/api/accounts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Get account to verify it exists and get company access
    ...
    app.get("/api/companies/:companyId/accounts-with-balances", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.get("/api/accounts/:id/ledger", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            const account = await storage.getAccount(id);
            ...
            const options = {};
            if (dateStart)
                options.dateStart = new Date(dateStart);
            if (dateEnd)
                options.dateEnd = new Date(dateEnd);
            if (search)
    ...
    app.get("/api/companies/:companyId/invoices", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Verify company access
    ...
    app.get("/api/invoices/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/companies/:companyId/invoices/check-similar", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/companies/:companyId/invoices", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/invoices/:id/post", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Get invoice
    ...
    app.put("/api/invoices/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            const { lines, date, ...invoiceData } = req.body;
    ...
    app.delete("/api/invoices/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Get invoice to verify it exists and get company access
    ...
    app.patch("/api/invoices/:id/status", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
    ...
    app.get("/api/companies/:companyId/receipts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Check if user has access to this company
    ...
    app.post("/api/companies/:companyId/receipts/check-similar", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/companies/:companyId/receipts", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Check if user has access to this company
    ...
    app.put("/api/receipts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.delete("/api/receipts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/receipts/:id/post", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.get("/api/companies/:companyId/customer-contacts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
            ...
            console.error('[CustomerContacts] Error fetching contacts:', error);
            res.status(500).json({ message: error.message });
        }
    });
    // Create single customer contact
    app.post("/api/companies/:companyId/customer-contacts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
            ...
            console.error('[CustomerContacts] Error creating contact:', error);
            res.status(400).json({ message: error.message });
        }
    });
    // Bulk import customer contacts from Excel
    app.post("/api/companies/:companyId/customer-contacts/import", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
            ...
            console.error('[CustomerContacts] Error importing contacts:', error);
            res.status(500).json({ message: error.message });
        }
    });
    // Update customer contact
    app.put("/api/companies/:companyId/customer-contacts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            ...
            console.error('[CustomerContacts] Error updating contact:', error);
            res.status(400).json({ message: error.message });
        }
    });
    // Delete customer contact
    app.delete("/api/companies/:companyId/customer-contacts/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId, id } = req.params;
            const userId = req.user.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
            ...
            console.error('[CustomerContacts] Error deleting contact:', error);
            res.status(500).json({ message: error.message });
        }
    });
    // =====================================
    ...
    app.get("/api/companies/:companyId/journal", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Check if user has access to this company
    ...
    app.post("/api/companies/:companyId/journal", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
    ...
    app.get("/api/journal/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Get journal entry
    ...
    app.put("/api/journal/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.post("/api/journal/:id/post", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            const entry = await storage.getJournalEntry(id);
    ...
    app.post("/api/journal/:id/reverse", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
    ...
    app.delete("/api/journal/:id", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user.id;
            // Get journal entry to verify it exists and get company access
    ...
    app.post("/api/ai/categorize", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            ...
            const accountList = expenseAccounts.map(acc => `${acc.nameEn}${acc.nameAr ? ` (${acc.nameAr})` : ''}`).join('\n');
...
Amount: ${validated.amount} ${validated.currency}`
    ...
    app.post("/api/ai/parse-bank-statement", authMiddleware, async (req, res) => {
        try {
            const { text } = req.body;
...
If no valid transactions can be found, return { "transactions": [] }`
            ...
            const validTransactions = (aiResponse.transactions || []).filter((t) => {
    ...
    // AI CFO Advice Route
    app.post("/api/ai/cfo-advice", authMiddleware, async (req, res) => {
        try {
...
Keep your tone professional but friendly, like a trusted advisor.`
    ...
    app.post("/api/ai/batch-categorize", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            ...
            const accountList = allAccounts.map(acc => `${acc.nameEn} (${acc.type})${acc.nameAr ? ` - ${acc.nameAr}` : ''}`).join('\n');
            ...
            const learningContext = previousClassifications
                ...
                .join('\n');
            const transactionList = transactions.map((t, i) => `${i + 1}. ${t.description} - Amount: ${t.amount} ${t.currency || 'AED'}`).join('\n');
            const completion = await openai.chat.completions.create({
                model: AI_MODEL,
                messages: [
                    {
...
Respond with a JSON object:
{
  "classifications": [
    ...
    app.post("/api/ai/detect-anomalies", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
...
Respond with JSON:
{
  ...
  "summary": {
    ...
    // Get Anomaly Alerts
    app.get("/api/companies/:companyId/anomaly-alerts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/anomaly-alerts/:id/resolve", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const { note } = req.body;
            const userId = req.user?.id;
    ...
    app.post("/api/ai/reconcile", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.body;
            const userId = req.user.id;
            if (!companyId) {
...
${JSON.stringify(ledgerData, null, 2)}`
    ...
    app.post("/api/bank-transactions/:id/reconcile", authMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user?.id;
    ...
    app.get("/api/companies/:companyId/bank-transactions", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Verify company access
    ...
    app.post("/api/companies/:companyId/bank-transactions", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            // Verify company access
    ...
    app.post("/api/companies/:companyId/bank-transactions/import", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/ai/forecast-cashflow", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
...
Respond with JSON:
{
  ...
  "riskFactors": [
    ...
    app.get("/api/companies/:companyId/forecasts", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/ai/classification-feedback", authMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/ai/nl-gateway", authMiddleware, async (req, res) => {
        try {
...
Company: ${company.name}`;
    ...
    app.get("/api/autocomplete/accounts", authMiddleware, async (req, res) => {
        try {
            ...
            let accounts = await storage.getAccountsByCompanyId(companyId);
            ...
            if (query) {
                ...
                accounts = accounts.filter(a => a.nameEn.toLowerCase().includes(q) ||
    ...
    app.get("/api/autocomplete/customers", authMiddleware, async (req, res) => {
        try {
    ...
    app.get("/api/autocomplete/merchants", authMiddleware, async (req, res) => {
        try {
            const { companyId, query, limit = 10 } = req.query;
            const userId = req.user.id;
            if (!companyId) {
    ...
    app.get("/api/autocomplete/descriptions", authMiddleware, async (req, res) => {
        try {
            const { companyId, query, type, limit = 10 } = req.query;
            const userId = req.user.id;
            if (!companyId) {
    ...
    app.post("/api/ai/smart-suggest", authMiddleware, async (req, res) => {
        try {
            ...
            if (fieldType === 'account' && context.merchant) {
                ...
                const receipts = await storage.getReceiptsByCompanyId(companyId);
                const merchantReceipts = receipts.filter(r => r.merchant?.toLowerCase() === context.merchant.toLowerCase() && r.journalEntryId);
...
Respond with just the account name, nothing else.`;
                    ...
                    const matchedAccount = expenseAccounts.find(a => a.nameEn.toLowerCase() === suggestedName?.toLowerCase());
                    if (matchedAccount) {
                        suggestions.push({
...
Respond with just the category name, nothing else.`;
    ...
    // =====================================
    app.get("/api/companies/:companyId/dashboard/stats", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const invoices = await storage.getInvoicesByCompanyId(companyId);
            const entries = await storage.getJournalEntriesByCompanyId(companyId);
    ...
    app.get("/api/companies/:companyId/dashboard/expense-breakdown", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const entries = await storage.getJournalEntriesByCompanyId(companyId);
            const accounts = await storage.getAccountsByCompanyId(companyId);
    ...
    app.get("/api/companies/:companyId/dashboard/monthly-trends", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const invoices = await storage.getInvoicesByCompanyId(companyId);
            const entries = await storage.getJournalEntriesByCompanyId(companyId);
    ...
    // Reports Routes
    // =====================================
    app.get("/api/companies/:companyId/reports/pl", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.get("/api/companies/:companyId/reports/balance-sheet", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const { startDate, endDate } = req.query;
            const accounts = await storage.getAccountsByCompanyId(companyId);
    ...
    app.get("/api/companies/:companyId/reports/vat-summary", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const { startDate, endDate } = req.query;
    ...
    app.get("/api/dashboard/recent-invoices", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.query;
            if (!companyId) {
                return res.json([]);
    ...
    app.get("/api/dashboard/expense-breakdown", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.query;
            if (!companyId) {
                return res.json([]);
    ...
    // Get sync history
    app.get("/api/integrations/sync-history", authMiddleware, async (req, res) => {
        try {
            ...
            let syncs;
            if (integrationType) {
                syncs = await storage.getIntegrationSyncsByType(companyId, integrationType);
            }
            else {
                syncs = await storage.getIntegrationSyncsByCompanyId(companyId);
            }
            res.json(syncs);
        }
        catch (error) {
    ...
    app.get("/api/integrations/google-sheets/spreadsheets", authMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/integrations/google-sheets/export/invoices", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/integrations/google-sheets/export/expenses", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId, spreadsheetId } = req.body;
            if (!companyId) {
                return res.status(400).json({ message: 'Company ID required' });
    ...
    app.post("/api/integrations/google-sheets/export/journal-entries", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId, spreadsheetId } = req.body;
            if (!companyId) {
                return res.status(400).json({ message: 'Company ID required' });
    ...
    app.post("/api/integrations/google-sheets/export/chart-of-accounts", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            const { companyId, spreadsheetId } = req.body;
            if (!companyId) {
                return res.status(400).json({ message: 'Company ID required' });
    ...
    app.post("/api/integrations/google-sheets/import/invoices", authMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/integrations/google-sheets/import/expenses", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId, sheetUrl } = req.body;
    ...
    app.post("/api/integrations/google-sheets/export/custom", authMiddleware, requireCustomerMiddleware, async (req, res) => {
        try {
            ...
            await storage.createIntegrationSync({
                ...
                dataType: 'custom',
                status: 'completed',
                recordCount: sheets.reduce((total, sheet) => total + (sheet.rows?.length || 0), 0),
                externalId: result.spreadsheetId,
                externalUrl: result.url,
            });
            res.json({
    ...
    app.get("/api/integrations/whatsapp/config", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.post("/api/integrations/whatsapp/config", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.patch("/api/integrations/whatsapp/toggle", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.get("/api/integrations/whatsapp/messages", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.get("/api/integrations/whatsapp/status", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.post("/api/ocr/process", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.post("/api/integrations/whatsapp/test-message", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            if (!userId) {
                return res.status(401).json({ message: 'Unauthorized' });
    ...
    app.get("/api/analytics/forecasts", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    app.post("/api/analytics/generate-forecast", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    app.get("/api/analytics/budget-vs-actual", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            ...
            const budgets = await storage.getBudgetsByCompanyId(companyId, parseInt(year) || new Date().getFullYear(), parseInt(month) || new Date().getMonth() + 1);
            const accounts = await storage.getAccountsByCompanyId(companyId);
            const journalLines = await storage.getJournalLinesByCompanyId(companyId);
            // Calculate actual amounts per account
            const actualsByAccount = {};
            journalLines.forEach(line => {
                if (!actualsByAccount[line.accountId])
                    actualsByAccount[line.accountId] = 0;
    ...
    // Get KPIs
    app.get("/api/analytics/kpis", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.query;
            if (!companyId) {
            ...
            // Get stored KPIs
            const kpis = await storage.getFinancialKpis(companyId);
            res.json(kpis);
        }
        catch (error) {
            res.status(500).json({ message: error.message });
    ...
    app.get("/api/integrations/ecommerce", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.query;
            if (!companyId) {
    ...
    app.get("/api/integrations/ecommerce/transactions", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.query;
            if (!companyId) {
                return res.status(400).json({ message: 'Company ID required' });
            }
            const transactions = await storage.getEcommerceTransactions(companyId);
            res.json(transactions || []);
        }
        catch (error) {
            res.status(500).json({ message: error.message });
    ...
    app.post("/api/integrations/ecommerce/connect", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    app.post("/api/integrations/ecommerce/:integrationId/sync", authMiddleware, async (req, res) => {
        try {
    ...
    app.patch("/api/integrations/ecommerce/:integrationId/toggle", authMiddleware, async (req, res) => {
        try {
            const { integrationId } = req.params;
    ...
    app.patch("/api/notifications/:id/dismiss", authMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
    ...
    // =====================================
    // Get regulatory news
    app.get("/api/regulatory-news", authMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/regulatory-news", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    app.get("/api/companies/:companyId/reminder-settings", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user?.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.post("/api/companies/:companyId/reminder-settings", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user?.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.patch("/api/reminder-settings/:id", authMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
    ...
    // Get reminder logs
    app.get("/api/companies/:companyId/reminder-logs", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user?.id;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.post("/api/invoices/:invoiceId/send-reminder", authMiddleware, async (req, res) => {
        try {
    ...
    app.patch("/api/onboarding", authMiddleware, async (req, res) => {
        try {
            ...
            if (data.hasCompletedWelcome)
                currentStep = 1;
            if (data.hasCreatedCompany)
                currentStep = 2;
            if (data.hasSetupChartOfAccounts)
                currentStep = 3;
            if (data.hasCreatedFirstInvoice)
                currentStep = 4;
            if (data.hasUploadedFirstReceipt)
                currentStep = 5;
            if (data.hasViewedReports)
                currentStep = 6;
            if (data.hasExploredAI)
                currentStep = 7;
            if (data.hasConfiguredReminders)
                currentStep = 8;
    ...
    app.post("/api/onboarding/complete-step", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            // Validate input with comprehensive schema
            const validationSchema = z.object({
    ...
    // Dismiss tip
    app.post("/api/onboarding/dismiss-tip", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            // Validate input
            const validationSchema = z.object({
    ...
    app.get("/api/help-tips", authMiddleware, async (req, res) => {
        try {
            ...
            let tips;
            if (page) {
                tips = await storage.getHelpTipsByPage(page);
            }
            else {
    ...
    app.get("/api/companies/:companyId/activity-logs", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
    ...
    app.get("/api/companies/:companyId/backups", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    // Create a new backup
    app.post("/api/companies/:companyId/backups", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
    ...
    app.get("/api/backups/:id", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { id } = req.params;
    ...
    app.get("/api/backups/:id/download", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { id } = req.params;
            const backup = await storage.getBackup(id);
    ...
    app.post("/api/backups/:id/restore-preview", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { id } = req.params;
            const backup = await storage.getBackup(id);
    ...
    // Delete backup
    app.delete("/api/backups/:id", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { id } = req.params;
            const backup = await storage.getBackup(id);
    ...
    app.get("/api/analytics/feature-usage", authMiddleware, async (req, res) => {
        try {
            const { feature } = req.query;
            const metrics = await storage.getFeatureUsageMetrics(feature);
            res.json(metrics);
        }
        catch (error) {
            res.status(500).json({ message: error.message });
    ...
    app.post("/api/companies/:companyId/bank-transactions/auto-reconcile", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.get("/api/bank-transactions/:id/match-suggestions", authMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const userId = req.user?.id;
    ...
    app.get("/api/companies/:companyId/vat-returns", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.post("/api/companies/:companyId/vat-returns/generate", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
    ...
    // Submit VAT return
    app.post("/api/vat-returns/:id/submit", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { id } = req.params;
    ...
    app.patch("/api/vat-returns/:id", authMiddleware, async (req, res) => {
        try {
            const { id } = req.params;
            const updateData = req.body;
            const vatReturn = await storage.updateVatReturn(id, {
    ...
    app.get("/api/companies/:companyId/team", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    // Invite team member
    app.post("/api/companies/:companyId/team/invite", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
    ...
    app.put("/api/companies/:companyId/team/:memberId", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    // Remove team member
    app.delete("/api/companies/:companyId/team/:memberId", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId, memberId } = req.params;
            const userRole = await storage.getUserRole(companyId, userId);
    ...
    app.get("/api/reports/:companyId/cash-flow/:period?", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
    ...
    // Aging report
    app.get("/api/reports/:companyId/aging", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId } = req.params;
            const hasAccess = await storage.hasCompanyAccess(userId, companyId);
    ...
    app.get("/api/reports/:companyId/comparison/:period?", authMiddleware, async (req, res) => {
        try {
            const userId = req.user?.id;
            const { companyId, period: pathPeriod } = req.params;
    ...
    app.patch("/api/admin/companies/:companyId", adminMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    async function fetchAndStoreRegulatoryNews(retryCount = 0) {
        const MAX_RETRIES = 3;
...
Make the news items realistic, current, and relevant to UAE businesses. Include recent dates.`
    ...
    app.post("/api/regulatory-news/fetch", authMiddleware, async (req, res) => {
        try {
    ...
    app.get("/api/companies/:companyId/documents", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/companies/:companyId/documents", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
    ...
    app.get("/api/companies/:companyId/tax-returns-archive", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/companies/:companyId/tax-returns-archive", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const returnData = {
    ...
    app.get("/api/companies/:companyId/compliance-tasks", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    app.post("/api/companies/:companyId/compliance-tasks", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const taskData = {
    ...
    app.patch("/api/compliance-tasks/:taskId", authMiddleware, async (req, res) => {
        try {
    ...
    app.delete("/api/compliance-tasks/:taskId", authMiddleware, async (req, res) => {
        try {
            const { taskId } = req.params;
    ...
    app.get("/api/companies/:companyId/messages", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
    ...
    // Send message
    app.post("/api/companies/:companyId/messages", authMiddleware, async (req, res) => {
        try {
            const { companyId } = req.params;
            const userId = req.user.id;
            const messageData = {
    ...
    app.get("/api/admin/clients", adminMiddleware, async (req, res) => {
        try {
            ...
            const clientsWithStats = await Promise.all(companies.map(async (company) => {
    ...
    app.patch("/api/admin/clients/:clientId", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
            const userId = req.user.id;
    ...
    app.delete("/api/admin/clients/:clientId", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
            const userId = req.user.id;
            const company = await storage.getCompany(clientId);
    ...
    app.post("/api/admin/invitations", adminMiddleware, async (req, res) => {
        try {
            const adminUserId = req.user.id;
    ...
    app.patch("/api/admin/invitations/:invitationId/revoke", adminMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/admin/invitations/:invitationId/resend", adminMiddleware, async (req, res) => {
        try {
            const { invitationId } = req.params;
            const adminUserId = req.user.id;
    ...
    app.delete("/api/admin/invitations/:invitationId", adminMiddleware, async (req, res) => {
        try {
            const { invitationId } = req.params;
    ...
    app.get("/api/admin/clients/:clientId/activity-logs", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
            const limit = parseInt(req.query.limit) || 100;
    ...
    app.get("/api/admin/clients/:clientId/notes", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
    ...
    app.post("/api/admin/clients/:clientId/notes", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
    ...
    app.patch("/api/admin/notes/:noteId", adminMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/admin/import/clients", adminMiddleware, async (req, res) => {
        try {
    ...
    app.post("/api/admin/import/preview", adminMiddleware, async (req, res) => {
        try {
    ...
    app.get("/api/admin/import/template", adminMiddleware, async (req, res) => {
        try {
            // Create sample data
            const sampleData = [
                {
    ...
    app.post("/api/admin/clients/:clientId/documents", adminMiddleware, async (req, res) => {
        try {
            const { clientId } = req.params;
            const userId = req.user.id;
            const documentData = {
