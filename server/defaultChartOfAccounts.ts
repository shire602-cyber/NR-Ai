...
export const defaultChartOfAccounts: DefaultAccountTemplate[] = [
  ...
  },
  {
    ...
    description: "Aggregate fixed asset cost account used for capitalization and disposal entries",
    type: "asset",
    subType: "fixed_asset",
    isVatAccount: false,
    vatType: null,
  ...
  {
    code: "2032",
    nameEn: "Pension Payable - GPSSA",
    nameAr: "المعاش المستحق - الهيئة العامة للمعاشات",
    description: "Employee and employer pension contributions due to GPSSA",
    type: "liability",
    subType: "current_liability",
    isVatAccount: false,
    vatType: null,
  ...
  },
  {
    ...
    nameAr: "استقطاعات الرواتب المستحقة",
    description: "Payroll deductions pending settlement",
    type: "liability",
    subType: "current_liability",
    isVatAccount: false,
    vatType: null,
  ...
  {
    code: "2036",
    nameEn: "End-of-Service Gratuity Provision",
    nameAr: "مخصص مكافأة نهاية الخدمة",
    description: "Accrued end-of-service gratuity liability",
    type: "liability",
    subType: "current_liability",
    isVatAccount: false,
    vatType: null,
  ...
  {
    code: "5025",
    nameEn: "Pension Expense (Employer)",
    nameAr: "مصروف المعاش (صاحب العمل)",
    description: "Employer share of GPSSA and GCC pension contributions",
    type: "expense",
    subType: null,
    isVatAccount: false,
    vatType: null,
  ...
  {
    code: "5028",
    nameEn: "End-of-Service Gratuity Expense",
    nameAr: "مصروف مكافأة نهاية الخدمة",
    description: "Periodic accrual of UAE end-of-service gratuity liability",
    type: "expense",
    subType: null,
    isVatAccount: false,
    vatType: null,
