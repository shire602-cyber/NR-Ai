...
- `client/src/lib/reportCatalog.ts` is the shared source for Reports catalog/workspace metadata,
  automation playbooks, automation-health scoring, persona preference storage, and command-palette
  report shortcuts; avoid duplicating report labels or deep links elsewhere.
