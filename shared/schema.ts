...
export const companies = pgTable("companies", {
  ...
  classifierConfig: jsonb("classifier_config")
    .notNull()
    .default(sql`'{"mode":"hybrid","accuracyThreshold":0.8,"autopilotEnabled":false}'::jsonb`)
    .$type<{
...
export const companyUsers = pgTable(
  ...
  (table) => ({
    companyUserUnique: unique("company_users_company_user_unique").on(
      table.companyId,
      table.userId
    ),
...
export const firmStaffAssignments = pgTable(
...
export const firmGrowthOpportunities = pgTable(
  "firm_growth_opportunities",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const firmGrowthActions = pgTable(
  "firm_growth_actions",
  {
    id: uuid("id")
      .primaryKey()
    ...
    opportunityId: uuid("opportunity_id")
      .notNull()
      .references(() => firmGrowthOpportunities.id, { onDelete: "cascade" }),
...
export const insertAccountSchema = createInsertSchema(accounts)
  ...
  .refine(
    ...
    {
      message:
        "vatType must be provided when isVatAccount is true, and must be null when isVatAccount is false",
    }
  );
...
export const creditNotes = pgTable(
  ...
  (table) => ({
    companyNumberUnique: unique("credit_notes_company_number_unique").on(
      table.companyId,
      table.number
    ),
...
export const purchaseOrders = pgTable(
  ...
  (table) => ({
    companyNumberUnique: unique("purchase_orders_company_number_unique").on(
      table.companyId,
      table.number
    ),
...
export const documentVersions = pgTable(
  ...
  (table) => ({
    documentIdx: index("idx_document_versions_document").on(
      table.companyId,
      table.documentType,
      table.documentId
    ),
...
export const recurringInvoices = pgTable(
  ...
  (table) => ({
    ...
    nextRunActiveIdx: index("idx_recurring_invoices_next_run_active").on(
      table.isActive,
      table.nextRunDate
    ),
  })
...
export const whatsappBridgeSessions = pgTable(
...
export const whatsappBridgeJobs = pgTable(
  "whatsapp_bridge_jobs",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    ...
    createdBy: uuid("created_by")
      .notNull()
      .references(() => users.id, { onDelete: "cascade" }),
    sessionId: uuid("session_id").references(() => whatsappBridgeSessions.id, {
      onDelete: "set null",
    }),
...
export const anomalyAlerts = pgTable(
  ...
  (table) => ({
    ...
    companyResolvedIdx: index("idx_anomaly_alerts_company_resolved").on(
      table.companyId,
      table.isResolved
    ),
  })
...
export const bankTransactions = pgTable(
  ...
  (table) => ({
    ...
    companyMatchStatusIdx: index("idx_bank_transactions_company_match").on(
      table.companyId,
      table.matchStatus
    ),
  })
...
export const insertTransactionClassificationSchema = createInsertSchema(
...
export const budgets = pgTable(
  ...
  (table) => ({
    companyPeriodIdx: index("idx_budgets_company_period").on(
      table.companyId,
      table.year,
      table.month
    ),
...
// ===========================
export const ecommerceIntegrations = pgTable(
...
// ===========================
export const ecommerceTransactions = pgTable(
  "ecommerce_transactions",
  {
    ...
    integrationId: uuid("integration_id")
      .notNull()
      .references(() => ecommerceIntegrations.id, { onDelete: "cascade" }),
    platform: text("platform").notNull(), // stripe | shopify | salesforce
...
export const reminderLogs = pgTable(
  ...
  (table) => ({
    ...
    relatedEntityIdx: index("idx_reminder_logs_related_entity").on(
...
export const vatReturns = pgTable(
  ...
  (table) => ({
    ...
    companyPeriodIdx: index("idx_vat_returns_company_period").on(
      table.companyId,
      table.periodStart
    ),
  })
...
// ===========================
export const vatReturnPeriods = pgTable(
  "vat_return_periods",
  {
    id: uuid("id")
      .primaryKey()
  ...
  (table) => ({
    companyPeriodUnique: unique("vat_return_periods_company_period_unique").on(
      table.companyId,
      table.periodStart,
      table.periodEnd
    ),
...
export const vatWorkpapers = pgTable(
  "vat_workpapers",
  {
    id: uuid("id")
      .primaryKey()
    ...
    generatedVatReturnId: uuid("generated_vat_return_id").references(() => vatReturns.id, {
      onDelete: "set null",
    }),
  ...
  (table) => ({
    companyPeriodUnique: unique("vat_workpapers_company_period_unique").on(
      table.companyId,
      table.periodStart,
      table.periodEnd
    ),
...
export const vatWorkpaperRows = pgTable(
  "vat_workpaper_rows",
  {
    id: uuid("id")
      .primaryKey()
    ...
    workpaperId: uuid("workpaper_id")
      .notNull()
      .references(() => vatWorkpapers.id, { onDelete: "cascade" }),
    companyId: uuid("company_id")
      .notNull()
      .references(() => companies.id, { onDelete: "cascade" }),
...
export const vatWorkpaperAttachments = pgTable(
  "vat_workpaper_attachments",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
// ===========================
export const taxReturnArchive = pgTable(
  "tax_return_archive",
  {
    id: uuid("id")
      .primaryKey()
...
export const complianceTasks = pgTable(
  ...
  (table) => ({
    ...
    companyStatusDueIdx: index("idx_compliance_tasks_company_status_due").on(
      table.companyId,
      table.status,
      table.dueDate
    ),
...
// ===========================
export const serviceInvoiceLines = pgTable(
  "service_invoice_lines",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    serviceInvoiceId: uuid("service_invoice_id")
      .notNull()
  ...
  (table) => ({
    serviceInvoiceIdIdx: index("idx_service_invoice_lines_service_invoice_id").on(
      table.serviceInvoiceId
    ),
  })
);
...
export const ftaEmails = pgTable(
  "fta_emails",
  {
    id: uuid("id")
      .primaryKey()
...
// ===========================
export const firmLeads = pgTable(
  "firm_leads",
  {
    id: uuid("id")
      .primaryKey()
...
export const paymentChases = pgTable(
  "payment_chases",
  {
    id: uuid("id")
      .primaryKey()
...
export const chaseTemplates = pgTable(
  ...
  (table) => ({
    companyLevelLangIdx: index("idx_chase_templates_lookup").on(
      table.companyId,
      table.level,
      table.language
    ),
...
export const documentChases = pgTable(
  "document_chases",
  {
    id: uuid("id")
      .primaryKey()
...
export const firmAlerts = pgTable(
  "firm_alerts",
  {
    id: uuid("id")
      .primaryKey()
...
export const firmMetricsCache = pgTable(
  "firm_metrics_cache",
  {
    id: uuid("id")
      .primaryKey()
