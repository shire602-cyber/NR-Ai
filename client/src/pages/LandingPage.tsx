...
const features = [
  ...
  },
  {
    ...
    description: "Create UAE VAT-ready tax invoices, send via email, and track payment status.",
    color: "text-cyan-500",
    bg: "bg-cyan-500/10",
  },
  {
...
const steps = [
  ...
  {
    number: "02",
    title: "Import Your Activity",
    description:
      "Upload bank statements, receipts, and invoices so the system can organize your books.",
    icon: Shield,
  },
  {
    number: "03",
    ...
    description:
      "Use AI-assisted categorization, VAT extraction, matching, and reporting with accountant review.",
    icon: Zap,
  },
];
...
const plans = [
  ...
  },
  {
    ...
    price: "99",
    period: "/month",
    description: "Guided automation for growing UAE SMEs.",
...
const stats = [
  { value: 7, suffix: "+", label: "Years in UAE Accounting" },
  { value: 2, suffix: "", label: "Languages Supported" },
  { value: 5, suffix: "%", label: "UAE VAT Workflows" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              UAE VAT workflows, AI receipt scanning, and Arabic support for accounting teams in one
              platform.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3}>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              No credit card required · Guided onboarding · UAE tax workflows
            </p>
          </ScrollReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Built from the ground up for UAE businesses — bilingual, AI-assisted, and accountant
              reviewed.
            </p>
          </ScrollReveal>
      ...
      <section id="how-it-works" className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Three steps from sign-up to organized, reviewable bookkeeping.
            </p>
          </ScrollReveal>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-primary-foreground/80 text-lg mb-8">
              Start with guided onboarding for UAE accounting and tax workflows.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                AI-assisted accounting for UAE businesses. Bilingual workflows with accountant
                review.
              </p>
            </div>
