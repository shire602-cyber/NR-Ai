...
export default function Pricing() {
  ...
  const t = {
        ...
        features:
          locale === "en"
            ...
            : [
                ...
                "مدير حساب مخصص",
                "تكاملات مخصصة",
                "شروط مستوى خدمة للمؤسسات أثناء الإعداد",
                "تحليلات متقدمة",
                "دعم متعدد الفروع",
                "وصول API",
              ],
    ...
    featureNames: {
      ...
      slaGuarantee: locale === "en" ? "Enterprise SLA Terms" : "شروط مستوى خدمة للمؤسسات",
    ...
    competitorFeatures: {
      ...
      eInvoicingComp: locale === "en" ? "E-Invoicing Readiness" : "جاهزية الفوترة الإلكترونية",
    ...
    faq: {
      ...
      questions: [
        ...
        },
        {
          ...
          a:
            locale === "en"
              ? "During launch, paid plans are activated through our onboarding team. Available payment methods are confirmed during setup and depend on the active billing configuration."
              : "خلال الإطلاق، يتم تفعيل الخطط المدفوعة عبر فريق الإعداد لدينا. يتم تأكيد طرق الدفع المتاحة أثناء الإعداد حسب تهيئة الفوترة النشطة.",
        },
        {
          q: locale === "en" ? "Do you offer refunds?" : "هل تقدمون استرداد أموال؟",
          a:
            locale === "en"
              ? "Refunds and cancellations follow the subscription terms shown at signup and in our Terms of Service."
              : "تتبع عمليات الاسترداد والإلغاء شروط الاشتراك المعروضة عند التسجيل وفي شروط الخدمة.",
        },
        {
          q: locale === "en" ? "Is my data secure?" : "هل بياناتي آمنة؟",
          a:
            locale === "en"
              ? "We protect customer data with authenticated access controls, encrypted transport, secure session handling, and regular security reviews. Hosting and residency details are confirmed in the production environment for each launch configuration."
              : "نحمي بيانات العملاء عبر ضوابط وصول موثقة، ونقل مشفر، وإدارة آمنة للجلسات، ومراجعات أمنية منتظمة. يتم تأكيد تفاصيل الاستضافة وموقع البيانات في بيئة الإنتاج لكل تهيئة إطلاق.",
        },
      ],
    },
    footerCta: {
      ...
      subtitle:
        locale === "en"
          ? "Start with UAE-focused accounting, tax workflows, and AI-assisted bookkeeping."
          : "ابدأ بمحاسبة مخصصة للإمارات، وسير عمل ضريبي، ومسك دفاتر بمساعدة الذكاء الاصطناعي.",
      startFree: locale === "en" ? "Start Free" : "ابدأ مجاناً",
      bookDemo: locale === "en" ? "Book a Demo" : "احجز عرض توضيحي",
      guarantee:
        locale === "en"
          ? "14-day trial  |  No credit card required  |  Guided launch onboarding"
          : "تجربة 14 يوم  |  لا حاجة لبطاقة ائتمان  |  إعداد إطلاق موجه",
    },
    nav: {
          ...
          <ScrollReveal>
            <Badge variant="secondary" className="mb-4 px-4 py-1.5 text-sm">
              ...
              {locale === "en"
                ...
                : "مصمم لسير عمل المحاسبة الإماراتية"}
            </Badge>
          </ScrollReveal>
