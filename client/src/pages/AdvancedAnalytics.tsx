  ...
  const sampleInsights: AIInsight[] = [
    {
      ...
      description:
        "Based on seasonal patterns, Q4 typically shows 22% higher revenue. Consider increasing marketing spend by 15% to capitalize.",
    ...
    },
    {
      ...
      description:
        "Operations expenses are 14% over budget this month. Primary driver: unexpected equipment maintenance costs.",
    ...
    },
    {
      ...
      description:
        "Cash flow has improved consistently over the past 3 months. Current trajectory suggests 25% improvement by Q2.",
    ...
    },
    {
      ...
      description:
        "Analysis shows AED 4,200 in potentially recoverable input VAT from recent equipment purchases.",
        ...
        <TabsContent value="budget" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="hover-elevate">
              ...
              <CardContent>
                <div className="text-2xl font-bold font-mono">{formatCurrency(250500, "AED")}</div>
                <p className="text-xs text-muted-foreground mt-1">
            ...
            <Card className="hover-elevate">
              ...
              <CardContent>
                <div className="text-2xl font-bold font-mono">{formatCurrency(247100, "AED")}</div>
                ...
                {sampleBudgetData.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-2 h-8 rounded-full ${isOverBudget ? "bg-red-500" : item.variance === 0 ? "bg-gray-400" : "bg-green-500"}`}
                        />
                        <div>
                      ...
                      <div className="text-right">
                        <p
                          className={`font-mono font-bold ${isOverBudget ? "text-red-600 dark:text-red-400" : item.variance === 0 ? "text-muted-foreground" : "text-green-600 dark:text-green-400"}`}
                        >
                          {item.variance > 0 ? "+" : ""}
                          {formatCurrency(item.variance, "AED")}
                        </p>
                        <p className="text-xs text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sampleKPIs.map((kpi, idx) => {
              const isPositiveTrend =
                kpi.type === "expense_ratio" || kpi.type === "dso"
                  ? kpi.trend === "down"
                  : kpi.trend === "up";
                ...
                <Card key={idx} className="hover-elevate relative overflow-hidden">
                  ...
                  <CardContent>
                    <div className="flex items-end justify-between">
                      <div>
                        <p
                          className={`text-3xl font-bold ${isPositiveTrend ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
                        >
                          {kpi.value.toFixed(1)}
                        ...
                        <div className="flex items-center gap-1 mt-2">
                          ...
                          <span
                            className={`text-xs font-medium ${isPositiveTrend ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
                          >
          ...
          <div className="grid gap-4">
            {sampleInsights.map((insight) => {
              ...
              return (
                <Card
                  key={insight.id}
                  className={`hover-elevate border-2 ${priorityColors[insight.priority]}`}
                >
                  <CardHeader>
