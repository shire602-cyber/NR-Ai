...
export default function BankReconciliation() {
  ...
  const downloadBankCsvTemplate = () => {
    ...
    a.href = url;
    a.download = "muhasib-bank-import-template.csv";
            ...
            {[
              {
                ...
                desc: "Upload CSV or PDF statements from UAE banks.",
              },
              {
                icon: Sparkles,
                title: "Review suggestions",
                desc: "Auto-match invoices, receipts, and journal entries before posting.",
              },
              {
                icon: CheckCircle2,
                title: "Close the month",
                desc: "Accept matches, keep exceptions visible, and export the report.",
              },
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:flex-wrap">
              ...
              >
                <SelectTrigger className="w-full sm:w-44" data-testid="select-bank-account">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/50 p-3 rounded-md text-sm space-y-1.5">
              ...
              <div className="flex items-center gap-2 text-xs">
                ...
                <span>CSV — Date, Description, Reference, Debit/Credit, Balance</span>
              </div>
              <div className="flex items-center gap-2 text-xs">
              ...
              <p className="pt-1 text-xs text-muted-foreground">
                Duplicate statement lines are skipped where possible, then suggested matches appear
                for review.
              </p>
            </div>
          </div>
