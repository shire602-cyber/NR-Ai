...
export default function VATFiling() {
  ...
  const handleExportPDF = (vatReturn: VATReturn) => {
    ...
    doc.setFontSize(7);
    doc.text(`Generated by Muhasib.ai | ${format(new Date(), 'dd/MM/yyyy HH:mm')} | FTA-Compliant`, pageWidth / 2, 285, { align: 'center' });
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-green-600/10 via-emerald-500/5 to-transparent border border-green-500/20 p-4 md:p-6 lg:p-8">
