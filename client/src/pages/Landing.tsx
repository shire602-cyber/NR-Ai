...
export default function Landing() {
  ...
  const t = {
    ...
    hero: {
      ...
      headline:
        locale === "en"
          ? "AI-Assisted UAE VAT/CIT Workflows"
          : "سير عمل ضريبة القيمة المضافة/الشركات بمساعدة الذكاء الاصطناعي",
      headlineAccent:
        locale === "en" ? "Built for UAE accounting teams." : "مصمم لفرق المحاسبة في الإمارات.",
      subheadline:
        locale === "en"
          ? "Track filing deadlines, categorize transactions faster, and keep accountant-reviewed UAE tax workflows in one workspace from NR Accounting Services."
          : "تتبع مواعيد التقديم، وصنّف المعاملات بسرعة أكبر، واجمع سير العمل الضريبي الإماراتي بمراجعة محاسب في مساحة واحدة من NR Accounting Services.",
      ...
      cancelAnytime: locale === "en" ? "UAE Tax Workflows" : "سير عمل ضريبي إماراتي",
    },
    stats: {
      invoices: locale === "en" ? "VAT Workflow Coverage" : "تغطية سير عمل ضريبة القيمة المضافة",
      accuracy: locale === "en" ? "AI Review Support" : "دعم المراجعة بالذكاء الاصطناعي",
      timeSaved: locale === "en" ? "Onboarding Support" : "دعم الإعداد",
      businesses: locale === "en" ? "Bilingual Workspace" : "مساحة عمل ثنائية اللغة",
    },
    features: {
    ...
    cta: {
      ...
      subtitle:
        locale === "en"
          ? "Start with guided onboarding for UAE accounting workflows"
          : "ابدأ بإعداد موجه لسير عمل المحاسبة الإماراتية",
  ...
  const features = [
    {
      ...
      description:
        locale === "en"
          ? "AI suggests expense categories so your team can review and post transactions faster."
          : "يقترح الذكاء الاصطناعي تصنيفات المصروفات حتى يتمكن فريقك من المراجعة والترحيل بسرعة أكبر.",
    ...
    },
    {
      ...
      description:
        locale === "en"
          ? "Create UAE VAT-ready invoices with automatic VAT calculation and PDF export."
          : "أنشئ فواتير جاهزة لضريبة القيمة المضافة في الإمارات مع حساب الضريبة وتصدير PDF.",
    ...
    },
    {
      ...
      description:
        locale === "en"
          ? "Encrypted transport, secure sessions, operational backups, and reviewable controls for UAE accounting teams."
          : "نقل مشفر، جلسات آمنة، نسخ احتياطي تشغيلي، وضوابط قابلة للمراجعة لفرق المحاسبة في الإمارات.",
  ...
  const testimonials = [
    {
      ...
      quote:
        locale === "en"
          ? "NR Accounting helped us organize VAT registration and bookkeeping workflows in one place. The guided review makes month-end easier."
          : "ساعدتنا NR Accounting في تنظيم سير عمل التسجيل لضريبة القيمة المضافة ومسك الدفاتر في مكان واحد. المراجعة الموجهة تجعل إقفال الشهر أسهل.",
      rating: 5,
    ...
    },
    {
      ...
      quote:
        locale === "en"
          ? "Managing 15+ properties is easier with AI-assisted categorization and bilingual support for Arabic and English documents."
          : "أصبحت إدارة أكثر من 15 عقاراً أسهل مع التصنيف بمساعدة الذكاء الاصطناعي والدعم ثنائي اللغة للمستندات العربية والإنجليزية.",
      rating: 5,
              ...
              <div className="relative lg:block" data-testid="hero-visual">
                ...
                <Floating intensity={15} duration={2}>
                  ...
                  >
                    ...
                    <span className="text-white text-sm font-medium">Review-ready</span>
                  </motion.div>
                </Floating>
              </div>
            </ScrollReveal>
        ...
        <div className="container max-w-7xl mx-auto px-6 lg:px-8">
          <p className="text-center text-sm text-muted-foreground mb-8">
            {locale === "en"
              ...
              : "مصمم لسير عمل المحاسبة في الإمارات"}
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground max-w-sm mb-6">
                {locale === "en"
                  ? "Registered accounting firm serving UAE businesses since 2017. AI-assisted bookkeeping with accountant-reviewed UAE tax workflows."
                  : "شركة محاسبة مسجلة تخدم الشركات الإماراتية منذ 2017. مسك دفاتر بمساعدة الذكاء الاصطناعي وسير عمل ضريبي إماراتي بمراجعة محاسب."}
              </p>
              <div className="flex items-center gap-4">
