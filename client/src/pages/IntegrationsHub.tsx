...
export default function IntegrationsHub() {
  ...
  const connectMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Connected",
        description: `${selectedPlatform?.name} integration connected successfully`,
      });
  ...
  const syncedTodayCount = transactionRows.filter(
    (txn) => txn.transactionDate?.slice(0, 10) === today
  ).length;
  ...
  const reconciledPercent =
    transactionRows.length > 0
      ? Math.round(
          (transactionRows.filter((txn) => txn.isReconciled).length / transactionRows.length) * 100
        )
      : 0;
            ...
            <Card className="hover-elevate">
              ...
              <CardContent>
                <div className="text-2xl font-bold font-mono">
                  {formatCurrency(monthlyTransactionValue, "AED")}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PLATFORMS.map((platform) => {
              ...
              return (
                <Card
                  key={platform.id}
                  className={`hover-elevate relative overflow-hidden ${isComingSoon ? "opacity-60" : ""}`}
                >
                  {isComingSoon && (
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Automatic transaction import eliminates manual data entry
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI-powered matching ensures accurate reconciliation
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                ...
                <div className="divide-y">
                  ...
                  {!transactionsLoading && transactionRows.length === 0 && (
                    <div className="p-10 text-center text-muted-foreground">
                      ...
                      <p className="text-sm">
                        Connect Stripe or Shopify and run a sync to populate this list.
                      </p>
                    </div>
                  )}
                  {!transactionsLoading &&
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className={`p-2 rounded-lg ${platform?.bgColor || "bg-muted"}`}>
                              <Icon
                                className={`w-5 h-5 ${platform?.color || "text-muted-foreground"}`}
                              />
                            </div>
                            <div>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure how data is synchronized from connected platforms
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically match transactions with invoices
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Include refunds in transaction imports
                  </p>
                </div>
      ...
      <Dialog open={connectDialogOpen} onOpenChange={setConnectDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your API credentials to connect {selectedPlatform?.name} with your bookkeeping
              system.
            </DialogDescription>
          </DialogHeader>
