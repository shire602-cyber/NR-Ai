...
const SAMPLE_COMPANY = {
  ...
  registrationNumber: "DED-123456",
  businessAddress: "Office 1204, Business Bay, Dubai, UAE",
  contactPhone: "+971 4 555 0100",
  contactEmail: "finance@demotrading.ae",
  emirate: "dubai",
};
...
function CustomerOnboarding() {
  ...
  function loadSampleData() {
    setCompanyForm(SAMPLE_COMPANY);
    setBankForm(SAMPLE_BANK);
    setCompanyFieldErrors({});
    setCompanySaveError(null);
    goTo("company", 1);
    toast({
      title: "Sample details loaded",
      description: "Review and edit the demo company before saving it to your workspace.",
    });
  }
    ...
    <div className="text-center space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground text-lg max-w-md mx-auto">
          UAE accounting workflows, VAT review, and AI-assisted insights - all in one place. This
          quick setup takes about 3 minutes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
        {[
          ...
          },
          {
            icon: Landmark,
            title: "Bank Account",
            desc: "Import statements for easier reconciliation",
          },
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
        ...
        <Button
          ...
          data-testid="onboarding-use-sample-data"
        >
