...
> = [
  ...
  {
    box: "1a",
    label: "Standard rated supplies — Abu Dhabi",
    amountKey: "box1aAbuDhabiAmount",
    vatKey: "box1aAbuDhabiVat",
    adjKey: "box1aAbuDhabiAdj",
  },
  {
    box: "1b",
    label: "Standard rated supplies — Dubai",
    amountKey: "box1bDubaiAmount",
    vatKey: "box1bDubaiVat",
    adjKey: "box1bDubaiAdj",
  },
  {
    box: "1c",
    label: "Standard rated supplies — Sharjah",
    amountKey: "box1cSharjahAmount",
    vatKey: "box1cSharjahVat",
    adjKey: "box1cSharjahAdj",
  },
  {
    box: "1d",
    label: "Standard rated supplies — Ajman",
    amountKey: "box1dAjmanAmount",
    vatKey: "box1dAjmanVat",
    adjKey: "box1dAjmanAdj",
  },
  {
    box: "1e",
    label: "Standard rated supplies — Umm Al Quwain",
    amountKey: "box1eUmmAlQuwainAmount",
    vatKey: "box1eUmmAlQuwainVat",
    adjKey: "box1eUmmAlQuwainAdj",
  },
  {
    box: "1f",
    label: "Standard rated supplies — Ras Al Khaimah",
    amountKey: "box1fRasAlKhaimahAmount",
    vatKey: "box1fRasAlKhaimahVat",
    adjKey: "box1fRasAlKhaimahAdj",
  },
  {
    box: "1g",
    label: "Standard rated supplies — Fujairah",
    amountKey: "box1gFujairahAmount",
    vatKey: "box1gFujairahVat",
    adjKey: "box1gFujairahAdj",
  },
  {
    box: "2",
    label: "Tax refunds provided to tourists",
    amountKey: "box2TouristRefundAmount",
    vatKey: "box2TouristRefundVat",
  },
  {
    box: "3",
    label: "Supplies subject to the reverse charge",
  ...
  { section: "VAT on expenses and all other inputs" },
  {
    ...
    adjKey: "box9ExpensesAdj",
  },
  {
    box: "10",
    label: "Supplies subject to the reverse charge (input)",
...
function addTitleBlock(
  ...
  const metaLines: string[][] = [
    ...
    [
      "Period",
      `${isoDate(workpaper.periodStart)} → ${isoDate(workpaper.periodEnd)}`,
      "Due date",
      isoDate(workpaper.dueDate) || "—",
    ],
    [
      "Status",
      String(workpaper.status).replace(/_/g, " "),
      "Generated",
...
function addWorkpaperSheet(workbook: ExcelJS.Workbook, detail: WorkpaperDetail): void {
  ...
  const totalRow = sheet.addRow([
    ...
    money(
      approved.reduce((sum: number, row: WorkpaperRow) => sum + money(row.adjustmentAmount), 0)
    ),
