...
export async function generatePurchaseOrderPDF(
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.text(formatAmount(po.subtotal, po.currency), totalsValueX - 80, y, {
        width: 80,
        align: "right",
      });
      y += 18;
      ...
      doc.text(formatAmount(po.vatAmount, po.currency), totalsValueX - 80, y, {
        width: 80,
        align: "right",
      });
      y += 22;
      ...
      doc.text(formatAmount(po.total, po.currency), totalsValueX - 80, y, {
        width: 80,
        align: "right",
      });
